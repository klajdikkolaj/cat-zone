  ...
  */
  ...
  export interface PhotoDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
    **/
    createManyAndReturn<T extends PhotoCreateManyAndReturnArgs<ExtArgs>>(
      args?: SelectSubset<T, PhotoCreateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$PhotoPayload<ExtArgs>, T, 'createManyAndReturn'>>
